            ...
            <div className="flex flex-col h-full justify-between">
                <div>
                    ...
                    <div className="flex flex-col gap-0 border border-[var(--border)]">
                        <details className="border-b p-0 shadow-sm overflow-hidden">
                            <summary className="cursor-pointer flex items-center justify-between px-6 py-4 text-xl font-semibold text-[var(--foreground)] bg-[var(--card)]">
                                ...
                                <span className="info-arrow transition-transform duration-200">
                                    <ChevronDownIcon className="w-5 h-5" />
                                </span>
                            </summary>
                            <div className="grid gap-4 p-6 text-[var(--muted-foreground)]">
                                <div className="bg-[var(--background)] border-l p-5">
                        ...
                        <details className="border-b p-0 shadow-sm overflow-hidden">
                            ...
                            <div className="space-y-4 p-6 text-[var(--muted-foreground)]">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <div className="bg-[var(--background)] border-l p-5 md:col-span-2">
                                        <p className="font-semibold text-[var(--foreground)]">IMF Bz</p>
                                        <p className="mt-2">
                        ...
                        <details className="border-b p-0 shadow-sm overflow-hidden">
                            ...
                            <div className="space-y-4 p-6 text-[var(--muted-foreground)]">
                                ...
                                <p className="bg-[var(--background)] border-l p-4 text-[var(--muted-foreground)]">
                        ...
                        <details className="p-0 shadow-sm overflow-hidden">
                            <summary className="cursor-pointer flex items-center justify-between px-6 py-4 text-xl font-semibold text-[var(--foreground)] bg-[var(--card)]">
