      ...
      <div className="flex flex-col gap-3">
        <Card>
          <div className="flex justify-between items-center">
            ...
            <Button className="!bg-[rgb(74,93,249)] hover:!bg-[rgb(66,82,237)]" onClick={() => ConvertToCSV(filteredDstData, "dst", selected)}>
        ...
        <Card>
          <div className="flex justify-between items-center">
            ...
            <Button className="!bg-[rgb(74,93,249)] hover:!bg-[rgb(66,82,237)]" onClick={() => ConvertToCSV(filteredSWSData, "solarwind", selected)}>
              <ArrowDownTrayIcon className="w-4 h-4" />            
            </Button>
          </div>
          <br />
        ...
        <Card>
          <div className="flex justify-between items-center">
            ...
            <Button className="!bg-[rgb(74,93,249)] hover:!bg-[rgb(66,82,237)]" onClick={() => ConvertToCSV(filteredIMFData, "imf", selected)}>
              <ArrowDownTrayIcon className="w-4 h-4" />
            </Button>
          </div>
          <br />
